// HORIZON PACK — RSI Mean Reversion @ weekly horizon (~5 bars held).
//
// One of twelve variants: three methods x four horizons, all reading the SAME 1day
// bars. "Weekly" is the target holding period, not a bar interval — the engine
...
//
// Weekly = swing horizon; roughly one trading week per position.
//
...
//   control-horizon-fixed.js   params { horizon: "weekly" }
//   control-horizon-random.js  params { horizon: "weekly", seed: 1..20 }
...
export default {
  name: "RSI Mean Reversion — Weekly",
  author: "Stockbot horizon pack",
  description: "RSI Mean Reversion scaled to a ~5-bar holding period on daily bars.",
  params: {period: 7, oversold: 30, exitLevel: 55, maxHoldBars: 10},
