// HORIZON PACK — EMA Momentum @ yearly horizon (~252 bars held).
//
...
export default {
  name: "EMA Momentum — Yearly",
  author: "Stockbot horizon pack",
  description: "EMA Momentum scaled to a ~252-bar holding period on daily bars.",
  params: {fast: 50, slow: 200, stopLossPercent: 30},
