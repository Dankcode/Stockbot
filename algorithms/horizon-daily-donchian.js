// HORIZON PACK — Donchian Breakout @ daily horizon (~2 bars held).
//
...
export default {
  name: "Donchian Breakout — Daily",
  author: "Stockbot horizon pack",
  description: "Donchian Breakout scaled to a ~2-bar holding period on daily bars.",
  params: {entryPeriod: 5, exitPeriod: 3, atrPeriod: 7, atrStopMultiple: 1.5},
