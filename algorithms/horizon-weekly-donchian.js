// HORIZON PACK — Donchian Breakout @ weekly horizon (~5 bars held).
//
...
export default {
  name: "Donchian Breakout — Weekly",
  author: "Stockbot horizon pack",
  description: "Donchian Breakout scaled to a ~5-bar holding period on daily bars.",
