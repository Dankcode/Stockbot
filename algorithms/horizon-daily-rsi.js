// HORIZON PACK — RSI Mean Reversion @ daily horizon (~2 bars held).
//
...
export default {
  name: "RSI Mean Reversion — Daily",
  author: "Stockbot horizon pack",
  description: "RSI Mean Reversion scaled to a ~2-bar holding period on daily bars.",
  params: {period: 3, oversold: 25, exitLevel: 55, maxHoldBars: 3},
